...
import com.zoopzam.partner.utils.svg.SvgSoftwareLayerSetter
...
object ImageManager {
    ...
    private val context = PhotoFinder.getInstance()
    ...
    fun loadCircularDrawableUsingHexCode(imageView: ImageView, hex_code: String?) {
        Glide.with(context)
                ...
                .placeholder(R.drawable.common_full_open_on_phone).into(imageView)
    }
