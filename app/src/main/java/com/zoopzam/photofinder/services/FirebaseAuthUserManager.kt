...
import com.zoopzam.photofinder.services.sharedpreference.SharedPreferenceManager
...
object FirebaseAuthUserManager {
    ...
    init {
        try {
            ...
            FirebaseApp.initializeApp(PhotoFinder.getInstance())
        }
...
//        }
        ...
        FirebaseInstanceId.getInstance().instanceId.addOnSuccessListener { instanceIdResult ->
            ...
            if (!TextUtils.isEmpty(fcmToken)) {
                getAppDisposable().add(
                        PhotoFinder.getInstance().getAPIService().registerFCM(
    ...
    private fun unregisterFCMToken() {
        FirebaseInstanceId.getInstance().instanceId.addOnSuccessListener { instanceIdResult ->
            ...
            if (!TextUtils.isEmpty(fcmToken)) {
                getAppDisposable().add(
                    PhotoFinder.getInstance().getAPIService().unregisterFCM(fcmToken!!)
                                .subscribeOn(Schedulers.io())
                                .observeOn(AndroidSchedulers.mainThread())
