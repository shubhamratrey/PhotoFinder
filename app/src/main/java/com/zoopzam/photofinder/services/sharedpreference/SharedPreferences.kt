package com.zoopzam.partner.services.sharedpreference

import android.content.Context
import android.content.SharedPreferences
import com.zoopzam.photofinder.BuildConfig
...
object SharedPreferences {
    ...
    private val prefs: SharedPreferences =
        PhotoFinder.getInstance().getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
